									...
									<div className="invoice_No">
										...
										<div className="row mt-5">
											<div className="col-md-9 input-group ">
												<input type="text" className="form-control" aria-label="Default" placeholder={file==="Payment-In" ? "Received Amount" : "Paid Amount"} aria-describedby="inputGroup-sizing-default" />
