								...
								<div className="mt-4 invoice_No row">
									<div className="input-group col-md-7">
										<div className="row">
											...
											<input type="text" className="form-control col-8 ml-4" />
										</div>
									</div>

									<div className="input-group col-md-7 mt-3 ">
										<div className="row">
											<label className="col-4 mt-2">Advance</label>
											<input type="text" className="form-control col-8 mb-3" />
										</div>
									</div>
