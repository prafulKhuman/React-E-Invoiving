				...
				<div className="modal-dialog modal-fullscreen">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="staticBackdropLabel">Purchase Bill</h5>
							...
							<div className="container-fluid">
								<div className="row">
									...
									<div className="col-3 invoice_No ">
										...
										<lable>Bill No </lable>
										<input type="text" className=" bottom_border ml-4 " />
								...
								<div className="row ">					
									<div className="col-3 invoice_No">
										...
										<input type="Date" className="bottom_border ml-4 mr-4 mb-3" />
								...
								<div className="mt-4 invoice_No row">
									...
									<div className="input-group col-md-7 mt-3">
										<div className="row">
											<label className="col-4 mt-2">Paid </label>
