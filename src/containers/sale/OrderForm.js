				...
				<div className="modal-dialog modal-fullscreen">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="staticBackdropLabel">Sale Order</h5>
						...
						<div className="modal-body">
							<div className="container-fluid">
								...
								<div className="row ">
									...
									<div className="col-md-2">
										<div className="input-group">
											<textarea className="form-control" aria-label="With textarea" placeholder="Shiping Address" />
										</div>
									</div>
									<div className="col-md-3 invoice_No">
										<label>Invoice Date</label>
										<input type="Date" className="bottom_border ml-3 mr-3" />
								...
								<div className="row">
									<div className="col-3 invoice_No">
										...
										<input type="Date" className="bottom_border ml-4 mr-2" />
								...
								<div className="mt-4 invoice_No row">
									...
									<div className="input-group col-md-7 mt-3 mb-3">
										<div className="row">
											<label className="col-4 mt-2">Recive </label>
