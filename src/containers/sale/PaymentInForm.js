				...
				<div className="modal-dialog modal-dialog-centered modal-xl">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="staticBackdropLabel">Payment In</h5>
									...
									<div className="invoice_No">
										...
										<div className="row mt-5">
											<div className="col-md-9 input-group ">
												<input type="text" className="form-control" aria-label="Default" placeholder="Received Amount" aria-describedby="inputGroup-sizing-default" />
